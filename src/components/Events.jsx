  ...
  return (
    <>
       <section className="clubs">
        <h1 className="intro text-center">Events photos</h1>
        <p className="text-center clubText">
       <span className="text-custom"> Experience </span>every moment of your <span className="text-custom"> event with the steadfast </span> support of your loved ones. <span className="text-custom"> Capture </span> Capture each special occasion not just <span className="text-custom">with photos </span>, but also<span className="text-custom"> with videos </span>, ensuring you can relive the <span className="text-custom">magic and memories </span> whenever <span className="text-custom"> you desire</span> .

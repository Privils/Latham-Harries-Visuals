  ...
  return (
   <>
    <section className="clubs">
        <h1 className="intro text-center">sport photos</h1>
        <p className="text-center clubText">
  Embrace living in <span className="text-custom">the moment </span> with the <span className="text-custom"> unwavering </span>support of your family by your side. <span className="text-custom">Capture each cherished </span> memory <span className="text-custom">not just in </span> photos, but in videos <span className="text-custom"> too, ensuring  </span> you can always <span className="text-custom">reminisce </span> about your glory <span className="text-custom">days </span> with vivid <span className="text-custom">clarity.</span>
</p>
